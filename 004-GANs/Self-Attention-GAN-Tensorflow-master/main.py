...
def parse_args():
    ...
    parser.add_argument('--epoch', type=int, default=10, help='The number of epochs to run  10')
    parser.add_argument('--iteration', type=int, default=4, help='The number of training iterations  10000,4')
    parser.add_argument('--batch_size', type=int, default=8, help='The size of batch per gpu  32,8')
    parser.add_argument('--print_freq', type=int, default=2, help='The number of image_print_freqy  500,2')
    parser.add_argument('--save_freq', type=int, default=2, help='The number of ckpt_save_freq  500,2')
