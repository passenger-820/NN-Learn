...
parser.add_argument('--path', type=str, default=[r'E:\PyCharmProject\NeuronNetwork\004-GANs\SAGAN_heykeetae\samples\sagan_01_project\sagan_01_celeba',
                                                 r'E:\PyCharmProject\NeuronNetwork\data\CelebA'],# nargs=2, # fake,real
