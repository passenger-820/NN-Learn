...
import os
from FID_data_loader import FIDImageDataset
...
data_root = os.path.join('./samples/sagan_10_project/02/sagan_10_100000')
my_dataset_fakeB = FIDImageDataset(data_root, batch_size=64, img_size=299, resize=True, rotation=False, normalize=[mean_inception, std_inception])
data_root = os.path.join('F:/PycharmProjects/GANs/data/animefaces')
my_dataset_realB = FIDImageDataset(data_root, batch_size=64, img_size=299, resize=True, rotation=False, normalize=[mean_inception, std_inception])
