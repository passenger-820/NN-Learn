...
def get_parameters():
    ...
    # bug: 没有参数l4
    # 你default=32，不走for循环，当然不会有l4（咱们用了sagan，所以才要改的）
    ...
    parser.add_argument('--version', type=str, default='sagan_anime_01')

    # Training setting
    parser.add_argument('--total_step', type=int, default=600000, help='how many times to update the generator')
    ...
    parser.add_argument('--d_lr', type=float, default=0.0004) # 0.0004
    ...
    parser.add_argument('--dataset', type=str, default='celeb', choices=['lsun', 'cifar'])
